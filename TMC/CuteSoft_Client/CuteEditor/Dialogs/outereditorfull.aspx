...
var OxO3133=["postback","Save"];function doClose(){Window_SetDialogReturnValue(window,null);var OxOec63=[];Window_CloseDialog(window);} ;function CuteEditor_OnCommand(editor,Ox4d,Ox4e,Ox4f){if(Ox4d.toLowerCase()==OxO3133[0]&&Ox4f==OxO3133[1]){Window_SetDialogReturnValue(window,'<%= Request.QueryString["f"]%>');} ;} ;
</script>

<asp:Panel runat=server Visible=false id="savedpanel">
<script language="JavaScript" type="text/javascript" >
var OxOec63=[];Window_CloseDialog(window);
</script>
</asp:Panel>