...
var OxOfd17=["ondblclick","navtd","shiftKey","style"];Window_GetElement(window,OxOfd17[1],true)[OxOfd17[0]]=function (){if(event[OxOfd17[2]]){alert(element[OxOfd17[3]].cssText);} ;} ;
</script>
