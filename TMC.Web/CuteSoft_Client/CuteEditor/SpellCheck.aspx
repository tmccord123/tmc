...
<head runat="server" id="Head1">
    ...
    <script type="text/javascript">
		var OxOcfec=[];window.focus();
    </script>
    <script language="JavaScript" src="Load.ashx?type=script&verfix=1006&file=spell.js&_x=0120" type="text/javascript"></script>
</head>
...
<script type="text/javascript">
var OxO247d=["ua","userAgent","isOpera","opera","isSafari","safari","isGecko","gecko","isWinIE","msie","isMac","Mac","availWidth","dialogWidth","availHeight","dialogHeight"];var _Browser_TypeInfo=null;function Browser__InitType(){if(_Browser_TypeInfo!=null){return ;} ;var Ox4={};Ox4[OxO247d[0]]=navigator[OxO247d[1]].toLowerCase();Ox4[OxO247d[2]]=(Ox4[OxO247d[0]].indexOf(OxO247d[3])>-1);Ox4[OxO247d[4]]=(Ox4[OxO247d[0]].indexOf(OxO247d[5])>-1);Ox4[OxO247d[6]]=(!Ox4[OxO247d[2]]&&!Ox4[OxO247d[4]]&&Ox4[OxO247d[0]].indexOf(OxO247d[7])>-1);Ox4[OxO247d[8]]=(!Ox4[OxO247d[2]]&&Ox4[OxO247d[0]].indexOf(OxO247d[9])>-1);Ox4[OxO247d[10]]=navigator[OxO247d[1]].indexOf(OxO247d[11])!=-1;_Browser_TypeInfo=Ox4;} ;Browser__InitType();function Browser_IsWinIE(){return _Browser_TypeInfo[OxO247d[8]];} ;try{if(Browser_IsWinIE()){top.moveTo((screen[OxO247d[12]]-self[OxO247d[13]])/2,(screen[OxO247d[14]]-self[OxO247d[15]])/2);} else {} ;} catch(x){} ;
</script>
